...
print("Exploring Information Architecture with Pyhton...\n")
...
sections = {
    "Home": "Welcome to the Homepage. This is my first time programming python.",
    "About": "About Page: mission, team, and background information.",
    "Services": "Services page: We provide free repairs of your desired device and one sosig.",
    "Contact": "Contact page: email and phone details"
}

services = ["Web Design", "App Repair", "Hotdog Seller"]
